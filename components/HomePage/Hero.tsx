...
const quickActions = [
  {
    icon: Search,
    label: 'Check Results',
    desc: 'Buy and check your results instantly',
    path: '/resultchecker',
  },
  {
    icon: GraduationCap,
    label: 'Find a Program',
    desc: 'Discover the right program for you',
    path: '/programmerecommendation',
  },
  {
    icon: CalendarClock,
    label: 'University Forms',
    desc: 'Access and submit university forms',
    path: '/universityforms',
  },
];

const images = ['/hero_img.jpg', '/hero_img4.jpg'];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-lg leading-relaxed">
              RightedUpath helps students check results, find programs,
              apply easily, and track their academic progress all in one place.
            </p>

            <div className="flex flex-wrap gap-4 mt-8">
              <Button
                onClick={() => router.push('/resultchecker')}
                size="lg"
