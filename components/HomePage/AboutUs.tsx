      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 leading-relaxed">
                    To be the leading platform that empowers every student
                    to discover, pursue, and succeed in the right academic path.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 leading-relaxed">
                    To simplify the academic journey by providing intelligent
                    tools, personalized guidance, and seamless application processes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 leading-relaxed mb-3">
                    Join thousands of students who are already on the right path.
                    Connect with us:
                  </p>
                  ...
                  <div className="flex gap-3">
                    {socials.map((s) => (
                      <a
                        key={s.label}
                        href={s.href}
                        className="p-2 rounded-lg border border-border hover:border-primary hover:bg-accent transition-all"
                        aria-label={s.label}
                      >
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="w-full aspect-4/3 rounded-2xl bg-linear-to-br from-secondary/20 via-secondary/10 to-primary/10 flex items-center justify-center overflow-hidden relative">
